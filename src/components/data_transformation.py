...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Obtaining preprocessro object")
            ...
            logging.info("Applying preprocessing obj on train and test data is done")
            ...
            logging.info("Saved preprocessing objexts")
